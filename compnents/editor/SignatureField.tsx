...
export default function SignatureField({
  ...
  return (
    <motion.div
      ...
      className={`absolute z-50 flex h-[32px] w-[80px] md:h-[60px] md:w-[180px] items-center justify-center transition-all duration-200 ${
        signedImage
          ? ""
    ...
    >
      {signedImage ? (
        ...
        <span className="text-[10px] md:text-xs">SIGN HERE</span>
      )}
